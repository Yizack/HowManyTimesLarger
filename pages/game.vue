...
<template>
  <div v-if="loaded && !loser" class="container-fluid vh-100">
    ...
    <div class="position-absolute top-50 start-50 translate-middle">
      <div class="bg-primary d-flex text-white rounded-circle align-items-center justify-content-center shadow mb-5" style="height: 100px; width: 100px; padding: 2%;">
        <div class="display-5"><b>VS</b></div>
      </div>
    </div>
  </div>
</template>
